...
function M.setup()
	...
	vim.keymap.set(MOVEMENT_MODES, "[o", function()
		move_if_parser_available("goto_previous_start", { "@loop.inner", "@loop.outer" }, TEXTOBJECT_QUERY_GROUP)
	end)
	vim.keymap.set(MOVEMENT_MODES, "]s", function()
		move_if_parser_available("goto_next_start", "@local.scope", "locals")
	end)
	vim.keymap.set(MOVEMENT_MODES, "[s", function()
		move_if_parser_available("goto_previous_start", "@local.scope", "locals")
	end)
	vim.keymap.set(MOVEMENT_MODES, "]z", function()
		move_if_parser_available("goto_next_start", "@fold", "folds")
	end)
	vim.keymap.set(MOVEMENT_MODES, "[z", function()
		move_if_parser_available("goto_previous_start", "@fold", "folds")
	end)
